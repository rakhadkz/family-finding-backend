...
ActiveRecord::Schema.define(version: 2021_04_23_174956) do
  ...
  create_table "cheerio_searches", force: :cascade do |t|
  ...
  create_table "family_searches", force: :cascade do |t|
    ...
    t.integer "relatives_count"
    t.integer "current_relatives"
  ...
  add_foreign_key "family_searches", "child_contacts"
